...
print(f'Вещественное число: {float(13)}')
print(f'Символ по его числовому представлению: {chr(97)}')
print(f'Модуль числа: {abs(-12)}')
print(f'Округление: {round(2.3)}')
print(f'Цело число: {int(13.23)}')
print(f'Строка: {str("Ri")}')
print(f'Строка: {len("Rira")}')
print(f'Сумма цифр: {sum([1, 5, 6])}')
s = 'подстрока в строке'
print(f'Количество вхождений: {s.count("стр")}')
s = 'a wonderful world'
print(f'Индекс первого вхождения: {s.find("wo", 4)}')
print(f'Копия строки с замененой вхождений  на указанное значение подстроки {s.replace("a", "the")}')
print(f'Разделённая страка: {s.split(" ")}')
print(f'Максимальное число: {max([1, 5, 2, 10])}')
print(f'Максимальное число: {min([1, 5, 2, 10])}')
print(f'Отсортированный объект (по возрастанию): {sorted([5, 3, 7, 4])}')
print(f'Отсортированный объект (по убыванию): {sorted([5, 3, 7, 4], reverse = 1)}')
print(f'Числовое представление для указанного символа: {ord("a")}')
print(f'Возвращает число с плавающей запятой, округлённое до указанного количества цифр после запятой: {round(4.345634,2)}')
print(f'Перевод в двоичную систему исчисления: {14:b}')
print(f'Перевод в восьмеричную систему исчисления: {14:o}')
print(f'Перевод в шестнадцатиричную систему исчисления: {14:x}')
print(f"Перевод в десятичную систему исчисления: {int('1000010000011100010', base=2)}")
...
print("(x and y) - логическое и, ^; (x or y) - логическое или, ∨; not(x) - логическое не, ¬x; "
      "(not(x) or y) - логическое слндование, (x → y); (x is y) - логическая равнозначность, x = y")
